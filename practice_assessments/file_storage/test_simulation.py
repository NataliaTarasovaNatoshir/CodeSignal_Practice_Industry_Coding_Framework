import unittest
from practice_assessments.file_storage.simulation import simulate_coding_framework
...
class TestSimulateCodingFramework(unittest.TestCase):
    ...
    def test_group_3(self):
        ...
        self.assertEqual(output, ["uploaded at Python.txt", "uploaded at CodeSignal.txt", "got at Python.txt",
                                  "copied at Python.txt to PythonCopy.txt", "found at [Python.txt, PythonCopy.txt]",
                                  "uploaded at Expired.txt", "file not found",
    ...
    def test_group_4(self):
        ...
        self.assertEqual(output, ["uploaded at Initial.txt", "uploaded at Update1.txt",
                                  "got at Initial.txt", "copied at Update1.txt to Update1Copy.txt",
                                  "uploaded at Update2.txt", "rollback to 2021-07-01T12:10:00",
                                  "got at Update1.txt", "got at Initial.txt",
                                  "found at [Update1.txt]", "file not found"])
